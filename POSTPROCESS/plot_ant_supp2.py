...
# =============================================== #
# inputs:
fdir  = 'RESULTS/EM1D_NCR/'
f1dm  = 'RESULTS/EM1D_NCR/'
f1dt  = 'RESULTS/EM1T_NCR/'
f3dm  = 'RESULTS/EM3D_NCR/'
f3dt  = 'RESULTS/EM3T_NCR/'
ftime = '../Data/tt_mFN'
istr  = '42'
ofile1 = 'RESULTS/PAPER_FIGURES/suppNCR_ant_diff.pdf'
ofile2 = 'RESULTS/PAPER_FIGURES/suppNCR_ant_diff_cbar.pdf'
...
axs[1,1].plot([slon,slon],[slat,slat],'^',ms=10,mfc='g',\
...
plt.contourf(d3t_1d,cmap='RdBu',\
                       vmin=cmin,vmax=cmax,\
                       levels=levels,norm=divnorm)
cbar = plt.colorbar(ticks=[cmin,0,cmax])
